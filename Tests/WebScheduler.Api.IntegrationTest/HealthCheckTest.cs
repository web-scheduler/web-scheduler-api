...
//    {
//        var response = await this.client.GetAsync(new Uri("/status", UriKind.Relative)).ConfigureAwait(true);
...
//    {
//        var response = await this.client.GetAsync(new Uri("/status/self", UriKind.Relative)).ConfigureAwait(true);
