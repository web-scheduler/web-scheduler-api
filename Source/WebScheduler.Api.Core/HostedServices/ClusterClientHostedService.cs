namespace WebScheduler.Api.Core.HostedServices;
...
public class ClusterClientHostedService : IHostedService, IAsyncDisposable, IDisposable
{
    ...
    private readonly WebSchedulerApiConfigurationOptions options;

    public ClusterClientHostedService(ILoggerFactory loggerFactory, IOptions<WebSchedulerApiConfigurationOptions> options, IClientBuilder clientBuilder)
    {
